...
4. Linux targets run inside Docker and can be built anywhere with Docker/QEMU support. macOS bundles need a macOS host; Windows bundles can be produced cross-platform but assume dependencies ship prebuilt binaries.
